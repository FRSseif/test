...
displayThisText("the number of ham sandwich than can be made: " + nbr_ham_sandwiches)
displayThisText("the number of tuna sandwich than can be made: " + nbr_tuna_sandwiches)
displayThisText("the number of vegetarian sandwich than can be made: " + nbr_vegetarian_sandwiches)